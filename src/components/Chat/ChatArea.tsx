        ...
        <div className="chat-area-container">
            <div className="chat-messages-list">
                {messages.map((msg) => {
                    ...
                    const author = msg.senderName ?? (isOwn ? user?.displayName ?? 'You' : 'Unknown');
                    return (
                        <div key={msg.id} className={`chat-message ${isOwn ? 'own' : ''}`}>
                            {msg.senderAvatar && (
                                <img src={msg.senderAvatar} alt={author} className="chat-message-avatar" />
                            )}
            ...
            {typingUser && <div className="chat-typing-indicator">{typingUser} is typing...</div>}
